...
public class CRUD extends javax.swing.JFrame {
    ...
    private int tipo = DAOAbstractFactory.JDBC;
    ...
    private void listarTabela() {
        ...
        try {
            ProdutoDAO produtoDAO = DAOAbstractFactory.getFactory(tipo).createProdutoDAO();
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        String selecao = jComboBox1.getSelectedItem().toString();
        if (selecao.equals("JDBC")) {
            tipo = DAOAbstractFactory.JDBC;
        }
        if (selecao.equals("HIBERNATE")) {
            tipo = DAOAbstractFactory.HIBERNATE;
        }
